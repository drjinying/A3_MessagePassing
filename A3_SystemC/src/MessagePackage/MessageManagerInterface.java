...
public class MessageManagerInterface {
	...
	private RMIMessageManagerInterface em = null; // Message manager interface
													// object
	...
	/***************************************************************************
	 * CONSTRUCTOR:: MessageManagerInterface() Purpose: This method registers
	 * participants with the message manager. This instantiation should be used
	 * when the message manager is on the local machine, using the default port
	 * (1099).
	 *
	 * Arguments: None.
	 *
	...
	public MessageManagerInterface()
			throws LocatingMessageManagerException, RegistrationException, ParticipantAlreadyRegisteredException {
		// First we check to see if the participant is already registered. If
		// not
		...
		if (ParticipantId == -1) {
			try {
				...
				throw new LocatingMessageManagerException(
						"Message manager not found on local machine at default port (1099)");
	...
	/***************************************************************************
	 * CONSTRUCTOR:: MessageManagerInterface( String IPAddress ) Purpose: This
	 * method registers participants with the message manager at a specified IP
	 * address. This instantiation is used when the MessageManager is not on a
	 * local machine.
	 *
	 * Arguments: None.
	 *
	...
	public MessageManagerInterface(String ServerIpAddress)
			throws LocatingMessageManagerException, RegistrationException, ParticipantAlreadyRegisteredException {
		// Assumes that the message manager is on another machine. The user must
		// provide the IP
		...
		if (ParticipantId == -1) {
			try {
				...
				throw new LocatingMessageManagerException(
						"Message manager not found on machine at:" + ServerIpAddress + "::" + e);
	...
	/***************************************************************************
	 * CONCRETE METHOD:: GetMyId Purpose: This method allows participants to get
	...
	/***************************************************************************
	 * CONCRETE METHOD:: GetRegistrationTime Purpose: This method allows
	 * participants to obtain the time of registration.
	 *
	 * Arguments: None.
	 *
	 * Returns: String time stamp in the format: yyyy MM dd::hh:mm:ss:SSS yyyy =
	...
	/***************************************************************************
	 * CONCRETE METHOD:: SendMessage Purpose: This method sends an message to
	 * the message manager.
	 *
	...
	/***************************************************************************
	 * CONCRETE METHOD:: GetMessage Purpose: This method sends an message to the
	 * message manager.
	 *
	 * Arguments: None.
	 *
	...
	/***************************************************************************
	 * CONCRETE METHOD:: UnRegister Purpose: This method is called when the
	 * object is no longer used. Essentially this method unregisters
	 * participants from the message manager. It is important that participants
	 * actively unregister with the message manager. Failure to do so will cause
	 * unconnected queues to fill up with messages over time. This will result
	 * in a memory leak and eventual failure of the message manager.
	 *
	 * Arguments: None.
	 *
	 * Returns: None.
