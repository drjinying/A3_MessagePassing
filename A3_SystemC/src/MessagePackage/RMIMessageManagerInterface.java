...
public interface RMIMessageManagerInterface extends Remote {
	...
	/***************************************************************************
	 * INTERFACE:: Register Purpose: This interface is used to access the
	 * participant registration service on the MessageManager
	 *
	 * Arguments: None
	 *
	...
	/***************************************************************************
	 * INTERFACE:: UnRegister Purpose:This interface is used to access the
	 * participant un-registration service on the MessageManager
	 *
	...
	/***************************************************************************
	 * INTERFACE:: SendMessage Purpose: This interface is used by participant to
	 * access the message sending service on the MessageManager
	 *
	...
	/***************************************************************************
	 * INTERFACE:: GetMessage Purpose: This interface is used to allow the
	 * participant access the message queue on the MessageManager
	 *
	 * Arguments: long integer registration number
	 *
