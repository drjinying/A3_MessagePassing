...
public class Indicator extends JFrame {
	...
	public Indicator(String Label, float Xpos, float Ypos) {
		...
		/*
		 * Calculate the X and Y position of the window's upper left hand corner
		 * as a proportion of the screen
		 */
	...
	public void paint(Graphics g) {
		...
		g.fillRoundRect((int) (Height * 0.15), (int) (Height * 0.35), (int) (Height * 0.70), (int) (Height * 0.40),
